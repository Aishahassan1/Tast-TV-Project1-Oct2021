...
An online live-streaming website made using HTML, CSS and JavaScript. I was provided with a 'movies' object which is where I pulled the moveis data from which fed through my website.
